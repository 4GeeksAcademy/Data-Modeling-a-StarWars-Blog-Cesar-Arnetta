...
Revision ID: 9c8a87ce41c4
Revises: a5cffa318ac2
Create Date: 2025-04-25 17:03:38.819235
...
def upgrade():
    ...
    sa.Column('they_live_in', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['they_live_in'], ['characters.characters_id'], ),
    sa.PrimaryKeyConstraint('planets_id')
    )
    op.create_table('favorites',
    sa.Column('favorites_id', sa.Integer(), nullable=False),
    sa.Column('users_id', sa.Integer(), nullable=False),
    sa.Column('favorite_type', sa.Enum('character', 'type', name='favorite_type_enum'), nullable=False),
    sa.Column('planets_id', sa.Integer(), nullable=False),
    sa.Column('they_live_in', sa.Integer(), nullable=False),
